...
class Tethertod:
    ...
    async def start(self):
        ...
        while True:
            ...
            if res.status_code != 200:
                return False
            self.log(f"success mining with : {click} block")
...
async def countdown(t):
    for i in range(t, 0, -1):
        ...
        print(f"waiting for repair pickaxe {hour}:{minu}:{sec} ", flush=True, end="\r")
...
async def main():
    ...
    print(
        """
    Script Mining YogaxD Miner USDT
    By: @yogakokxd
    Your Address : UQDCc5yLXcC95Oe3YH891zs7937cTfLlHoBpToBiWAcO3D0U
    Auto Send : $1.00
    =================================================================
          """
    )
    datas = open("data.txt").read().splitlines()
    print(f"total rent miner : 1")
    print(f"total pickaxe : {len(datas)}")
    print(f"Est Perhours : $0.001/hours")
    print(f"=================================================================")
    print(f"")
    while True:
        tasks = [
